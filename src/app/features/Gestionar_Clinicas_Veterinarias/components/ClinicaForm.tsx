...
import { User, Mail, Phone, MapPin, Hash, Globe, CheckCircle2 } from 'lucide-react'
  ...
  const form = useForm({
    defaultValues: {
      ...
      permite_auto_registro_clientes:
        veterinaria?.permite_auto_registro_clientes ?? false,
    },
              ...
              <>
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Ej: Veterinaria Felina"
              ...
              <>
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) => field.handleChange(e.target.value)}
                    onBlur={field.handleBlur}
                    placeholder="veterinaria-felina"
                    className="pl-9 bg-white text-black"
                  />
                </div>
                {field.state.meta.errors.length > 0 && (
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <form.Field
            ...
            validators={{
              onChange: ({ value }) =>
                !value.trim() ? 'El NIT es requerido' : undefined,
            }}
          >
            {(field) => (
              <>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <form.Field
            ...
            validators={{
              onChange: ({ value }) =>
                !value.trim() ? 'La dirección es requerida' : undefined,
            }}
          >
            {(field) => (
              <>
        ...
        <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/10 p-4 shadow-sm">
          <div>
            ...
            <p className="text-xs text-gray-200">
              Permite que los clientes se registren automáticamente.
            </p>
          </div>
